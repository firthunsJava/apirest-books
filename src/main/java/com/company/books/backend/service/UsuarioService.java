...
public class UsuarioService implements UserDetailsService {
 ...
 /*    transformo mi lista de roles en una lista de GrantedAuthority */
        List<GrantedAuthority> authorities = usuario.getRoles()
                .stream()//trabajar con un flujo de datos y lo vamos a transformar
                .map( role -> new SimpleGrantedAuthority(role.getNombre()))//
                .peek( authority -> log.info("Role: "+ authority.getAuthority()))//metodo peek, para ir imprimiento los authority
